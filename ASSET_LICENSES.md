...
- The released demo uses an original deterministic bell, pluck, pad and soft-bass arrangement generated by the repository script. It does not sample, reproduce, remix or redistribute an official A-SOUL song, a Diana cover, or a third-party recording.
- The narration is generated from the repository script text; no Diana voice sample or cloned character voice is used.

The music generator and narration/subtitle text are covered by the repository's MIT License. The rendered video still contains the Diana visual assets described above and therefore remains a non-commercial fan work rather than an all-assets-MIT package.
